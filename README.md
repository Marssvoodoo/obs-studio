...
The current branch is merged with the exact upstream `32.2.0-rc2` tag. It keeps
...
dynamic bitrate, and upstream performance, security, and stability fixes.

## Downloads

Fork release tags use the format
`<base-version>-voodoo<revision>`, for example
`32.2.0-rc2-voodoo1`. A tag build creates the same platform and debug-symbol
